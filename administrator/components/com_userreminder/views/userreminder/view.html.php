...
class userreminderViewUserreminder extends JViewLegacy
{
	...
	function _display($tpl = null){
		...
		JToolbarHelper::custom('sendUserTestMail', 'envelope', '', JText::_( 'USERREMINDER_SEND_TEST' ), false);
		JToolBarHelper::custom( 'sendUserReminder', 'envelope', '', JText::_( 'USERREMINDER_USER_SEND' ), false, false );
