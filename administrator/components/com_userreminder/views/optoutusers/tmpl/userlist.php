...
$search = $this->escape(JFactory::getApplication()->input->get('filter_search', null, 'string'));
...
<div>
    ...
    <ul class="nav nav-tabs" id="submenu">
        <li class="nav-item">
            <a class="nav-link" href="index.php?option=com_userreminder&task=optuserPanel"><?php echo JText::_('USERREMINDER_USER_LIST')?></a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="index.php?option=com_userreminder&task=optoutusers.userlist"><?php echo JText::_('USERREMINDER_OPTOUT_USERS')?></a>
        </li>
        <li class="nav-item">
        ...
        <form method="post" name="adminForm" id="adminForm" action="index.php?option=com_userreminder">
            ...
            <table class="table table-striped" id="articleList">
                ...
                <tr>
                    ...
                    <th><?php echo JHtml::_( 'grid.sort', JText::_('USERREMINDER_NAME__'), 'name', $this->sortDirection, $this->sortColumn, 'optoutusers.userlist'); ?></th>
                    <th><?php echo JHtml::_( 'grid.sort', JText::_('USERREMINDER_NAME'), 'username', $this->sortDirection, $this->sortColumn, 'optoutusers.userlist'); ?></th>
                    <th><?php echo JHtml::_( 'grid.sort', JText::_('USERREMINDER_EMAIL'), 'email', $this->sortDirection, $this->sortColumn, 'optoutusers.userlist'); ?></th>
                    <th><?php print JText::_('USERREMINDER_LASTLOGINDATE'); ?></th>
                    <th><?php print JText::_('USERREMINDER_REGISTRATIONDATE'); ?></th>
                </tr>
                </thead>
                <tbody>
                <?php foreach ($userList as $i => $item) :?>
                    <tr>
                        <td class="center">
                ...
                <tr>
                    <td colspan="6">
                        <br />
                        <?php  echo $this->userPagination->getListFooter(); ?>
                    </td>
                </tr>
                </tfoot>
            </table>
