    ...
    <div class="tab-content">
            ...
            <table class="table table-striped" id="articleList">
                ...
                <tr>
                    ...
                    <th><?php echo \Joomla\CMS\HTML\HTMLHelper::_( 'grid.sort', \Joomla\CMS\Language\Text::_('USERREMINDER_NAME__'), 'name', $this->sortDirection, $this->sortColumn, 'optoutusers.userlist'); ?></th>
                    <th><?php echo \Joomla\CMS\HTML\HTMLHelper::_( 'grid.sort', \Joomla\CMS\Language\Text::_('USERREMINDER_NAME'), 'username', $this->sortDirection, $this->sortColumn, 'optoutusers.userlist'); ?></th>
                    <th><?php echo \Joomla\CMS\HTML\HTMLHelper::_( 'grid.sort', \Joomla\CMS\Language\Text::_('USERREMINDER_EMAIL'), 'email', $this->sortDirection, $this->sortColumn, 'optoutusers.userlist'); ?></th>
